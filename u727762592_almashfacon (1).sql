...
--
-- مضيف: 127.0.0.1:3306
-- وقت الجيل: 30 مايو 2026 الساعة 17:31
...
--
-- قاعدة بيانات: `u727762592_almashfacon`
--
...
(18, 'عمر العوضي', '2026-01-01', NULL, NULL, 12000.00, 'fixed', 54000.00, 2400.00, 0, 6, '', 0.00, 'low', NULL, NULL, 'نفسي', 'علي الجندي', '', '', '', NULL, '', NULL, 'active', '2026-05-22 15:23:48', 0, 0.00, 0.00, 0, 50.00, 0.00, 0, 0, '2026-05-22'),
(19, 'منير محمد منير', '2025-12-31', NULL, NULL, 10000.00, 'fixed', 42000.00, 5333.33, 0, 16, 'علاء', 0.00, 'low', NULL, NULL, 'إدمان', 'ايه', '', '', '', NULL, '', NULL, 'active', '2026-05-22 15:25:05', 0, 0.00, 0.00, 0, 50.00, 0.00, 0, 0, '2026-05-22'),
(20, 'عبدالمحسن فوزي', '2026-01-21', NULL, NULL, 8000.00, 'fixed', 29400.00, 2866.67, 0, 11, '', 0.00, 'low', NULL, NULL, 'إدمان', 'علي الجندي', '', '', '', NULL, '', NULL, 'active', '2026-05-22 15:27:58', 400, 0.00, 0.00, 15, 50.00, 150.00, 3, 23, '2026-05-22'),
(21, 'محمد عمر', '2026-01-22', NULL, NULL, 10000.00, 'fixed', 33000.00, 7000.00, 0, 21, '', 0.00, 'low', NULL, NULL, 'إدمان', 'ايه', '', '', '', NULL, '', NULL, 'active', '2026-05-22 15:29:58', 0, 0.00, 0.00, 20, 50.00, 1500.00, 30, 30, '2026-05-22'),
(22, 'عبدالرحمن الجزار', '2026-02-04', NULL, NULL, 12000.00, 'fixed', 35000.00, 7800.00, 0, 20, 'بسام', 0.00, 'low', NULL, NULL, '', 'ايه', '', '', '', NULL, '', NULL, 'active', '2026-05-22 15:30:53', 0, 0.00, 0.00, 0, 50.00, 0.00, 0, 0, '2026-05-22');
...
CREATE TABLE `patient_balance` (
  ...
  `type` enum('cigarettes','external_cash') NOT NULL,
...
CREATE TABLE `patient_transactions` (
  `id` int(11) NOT NULL,
  `patient_id` int(11) NOT NULL,
  `type` enum('cigarettes','external_expense','deposit','charge') NOT NULL,
  `quantity` int(11) DEFAULT 0,
  `amount` decimal(10,2) DEFAULT 0.00,
...
(42, 20, 'cigarettes', 400, 0.00, 0.00, 0.00, 'متسجلين الف جنيه', NULL, '2026-05-22 15:28:54');
...
--
-- فهارس للجدول `patient_transactions`
--
